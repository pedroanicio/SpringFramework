...
import dio.padroes_projeto_spring.repository.ClienteRepository;
import dio.padroes_projeto_spring.repository.EnderecoRepository;
import dio.padroes_projeto_spring.service.*;
...
public class ClienteServiceImpl implements ClienteService {
    ...
    public Cliente buscarPorId(Long id) {
        ...
        Optional<Cliente> cliente = clienteRepository.findById(id); //pode existir ou nao
        return cliente.get();
    }
    ...
    private void salvarClienteComCep(Cliente cliente) {
        ...
        Endereco endereco = enderecoRepository.findById(cep).orElseGet(() -> {
            //caso endereco nao exista, integrar com o viacep e persistir o retorno
